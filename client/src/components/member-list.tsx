  ...
  return (
    <Sheet open={Open} onOpenChange={onOpenChange}>
      <SheetTrigger asChild>
        <Button className="fixed bottom-4 right-4 z-50 bg-[#2E7D32] hover:bg-[#1B5E20] text-white">
          <Users className="h-4 w-4 mr-2" />
          Members
        </Button>
      </SheetTrigger>
      <SheetContent side="bottom" className="rounded-t-3xl p-4 h-[60vh] overflow-y-auto z-[1001]" >
